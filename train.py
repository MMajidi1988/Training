...
comet_ml.init(project_name='Tranig_Hockey_round3')
...
models_to_load = {
    'yolov8n': {'path': '/home/majidi/D1/Hockey/yolov8n.pt',   'load': False},  # nano - 3.2 Million parameters
    'YOLOv8s': {'path': '/home/majidi/D1/Hockey/Models/yolov8s.pt', 'load': False},   # small - 11.2 million parameters
    'YOLOv8m': {'path': '/home/majidi/D1/Hockey/Models/yolov8m.pt', 'load': True},  # medium - 25.9 million parameters
    'YOLOv8l': {'path': '/home/majidi/D1/Hockey/Models/yolov8l.pt',  'load': False},  # large - 43.7 million parameters
    'YOLOv8x': {'path': '/home/majidi/D1/Hockey/Models/yolov8x.pt', 'load': False},  # Xlarge - 68.2 million parameters
    'Sc-m-P': {'path': '/home/majidi/D1/Hockey/Sc-m-P/train/weights/best.pt', 'load': False},
    'yolov8m-football': {'path': '/home/mehdihou/D1/YOLO-Train/Train/Models/yolov8Football/yolov8m-football.pt', 'load': False},  # YOLOv8-Football - Medium Version
}
